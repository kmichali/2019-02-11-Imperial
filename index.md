...
instructor: ["Amit Mandal, Krishnakumar Gopalakrishnan, Lucy Whalley, Navjot Kukreja"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jeremy Cohen, Kiana West, Jazz Mack Smith, Katerina Michalickova"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
{% comment %}
  ...
  If you want to use an Etherpad, go to
      ...
      http://pad.software-carpentry.org/2019-02-11-Imperial
